...
module.exports = (sequelize, DataTypes) => {
  class Data_Acara_Organisasi extends Model {
    /**
  ...
  Data_Acara_Organisasi.init({
    ...
    sequelize,
    modelName: 'Data_Acara_Organisasi',
  });
  return Data_Acara_Organisasi;
};